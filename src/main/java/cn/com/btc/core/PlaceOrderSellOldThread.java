...
public class PlaceOrderSellOldThread extends Thread {
    private static final Logger logger = LoggerFactory.getLogger(PlaceOrderSellOldThread.class);
    ...
    public PlaceOrderSellOldThread(String symbol, OrderList orderList, Decimal decimal) {
